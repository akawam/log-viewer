                                ...
                                <th scope="col">
                                    <div class="flex justify-between">
                                        ...
                                        <div>
                                            ...
                                            <select id="log-sort-direction" wire:model="direction"
                                            ...
                                            <select id="items-per-page" wire:model="perPage"
                                    ...
                                    <td colspan="6">
                                        ...
                                        @if($log->fullTextIncomplete)
                                            <div class="py-4 px-8 text-gray-500 italic">
                                                ...
                                                first {{ \Opcodes\LogViewer\Utils\Utils::bytesForHumans(\Opcodes\LogViewer\Facades\LogViewer::maxLogSize()) }}.
                                            ...
                                            <div class="text-center mt-6">
                                                @if(!empty($query))
                                                    <button
                                                        ...
                                                        wire:click="clearQuery">Clear search query
                                                    </button>
                                                @endif
                                                @if(!empty($query) && isset($file))
                                                    <button
                                                        ...
                                                        x-on:click.prevent="selectFile(null)">Search all files
                                                    </button>
                                                @endif
                                                @if(isset($levels) && count(array_filter($levels, function ($level) { return $level->selected;})) === 0 && count(array_filter($levels, function ($level) { return $level->count > 0;})))
                                                    <button
                                                        class="px-3 ml-3 py-2 border dark:border-gray-700 text-gray-800 dark:text-gray-200 hover:border-emerald-600 dark:hover:border-emerald-700 rounded-md"
                                                        wire:click="selectAllLevels">Select all severities
                                                    </button>
                                                @endif
                                            </div>
                                        </div>
